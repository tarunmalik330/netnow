  ...
  return (
    <>
      <div className="bg-[url('./assets/images/png/BgRoadmap.png')] lg:bg-BgSize bg-cover bg-center bg-no-repeat translate-y-[-2%] relative z-[3]">
        ...
        >
          <h2
            className="ff_archivo text-white text-center font-normal leading-[121%] sm:text-[48px] text-[40px] xl:mb-[78.96px] mb-[30px]"
            data-aos="zoom-in-up"
          >
            Roadmap
          </h2>
          <div className="relative">
            <div
              className="absolute h-full top-0 lg:left-[23.5%] sm:left-[3.5%] left-[5.5%] bottom-[-200px] border-dashed border-[3px] border-spacing-y-10 opacity-[60%] border-white border-t-0 border-b-0 border-l-0"
              data-aos="zoom-in-up"
            ></div>
            <div
              className="flex flex-row flex-wrap sm:gap-8 justify-between xl:mb-[91px] sm:mb-[50px] mb-[20px] relative"
              data-aos="zoom-in-up"
            >
            ...
            <div
              className="flex flex-row flex-wrap sm:gap-8 justify-between xl:mb-[100px] sm:mb-[50px] mb-[20px]"
              data-aos="zoom-in-up"
            >
              <div className="lg:block hidden w-[17%]">
                <div className="bg-[url('./assets/images/png/BgButton.png')] bg-BgSize bg-center bg-no-repeat max-w-[187px] w-full flex justify-center items-center pt-[11px] pb-[12px]">
            ...
            <div
              className="flex flex-row flex-wrap sm:gap-8 justify-between xl:pb-[91px] sm:pb-[50px] pb-[20px]"
              data-aos="zoom-in-up"
            >
              <div className="lg:block hidden w-[17%]">
                <div className="bg-[url('./assets/images/png/BgButton.png')] bg-BgSize bg-center bg-no-repeat max-w-[187px] w-full flex justify-center items-center pt-[11px] pb-[12px]">
        ...
        <div className="xl:pt-[190px] sm:pt-[80px] pt-[30px]">
          <div className=" flex justify-center items-center flex-col sm:mb-[64px] mb-[10px] px-6">
            <h2
              className="text-center text-white sm:text-[48px] text-[35px] font-normal ff_archivo leading-[121%] mb-[16px]"
              data-aos="zoom-in-up"
            >
          ...
          <div className="w-full">
            <Slider {...settings}>
              <div className="px-3">
                <div className="Slider_card max-sm:mx-auto relative rounded-[20px] max-w-[363px]">
                  <div className="mt-[17px] mb-[17.88px] ml-[17.6px] mr-[16.79px] rounded-[16px]">
                    <div className="bg-[url('./assets/images/png/SliderAlien3.png')] rounded-[16px] Img_shadow lg:bg-BgSize bg-center bg-cover bg-no-repeat h-[340px] w-full max-w-[330px] flex items-end">
              ...
              <div className="px-3">
                <div className="Slider_card max-sm:mx-auto relative rounded-[20px] max-w-[363px]">
                  <div className="mt-[17px] mb-[17.88px] ml-[17.6px] mr-[16.79px] rounded-[16px]">
                    <div className="bg-[url('./assets/images/png/SliderAlien1.png')] rounded-[16px] lg:bg-BgSize bg-center bg-cover bg-no-repeat h-[340px] w-full max-w-[330px] flex items-end">
                      <div className="pl-[20px] pb-[20px] flex flex-col content_opacity">
                        <p className="ff_archivo text-[24px] font-normal text-white leading-[121%] mb-[6px]">
                          Evol Benji
                        </p>
              ...
              <div className="px-3">
                <div className="Slider_card max-sm:mx-auto relative rounded-[20px] max-w-[363px]">
                  <div className="mt-[17px] mb-[17.88px] ml-[17.6px] mr-[16.79px] rounded-[16px]">
                    <div className="bg-[url('./assets/images/png/SliderAlien2.png')] rounded-[16px] Img_shadow lg:bg-BgSize bg-center bg-cover bg-no-repeat h-[340px] w-full max-w-[330px] flex items-end">
                      <div className="pl-[20px] pb-[20px] flex flex-col content_opacity">
                        <p className="ff_archivo text-[24px] font-normal text-white leading-[121%] mb-[6px]">
                          Evol Benji
                        </p>
              ...
              <div className="px-3">
                <div className="Slider_card max-sm:mx-auto relative rounded-[20px] max-w-[363px]">
                  <div className="mt-[17px] mb-[17.88px] ml-[17.6px] mr-[16.79px] rounded-[16px]">
                    <div className="bg-[url('./assets/images/png/SliderAlien1.png')] rounded-[16px] Img_shadow lg:bg-BgSize bg-center bg-cover bg-no-repeat h-[340px] w-full max-w-[330px] flex items-end">
                      <div className="pl-[20px] pb-[20px] flex flex-col content_opacity">
                        <p className="ff_archivo text-[24px] font-normal text-white leading-[121%] mb-[6px]">
                          Evol Benji
                        </p>
              ...
              <div className="px-3">
                <div className="Slider_card relative rounded-[20px] max-w-[363px]">
                  <div className="mt-[17px] mb-[17.88px] ml-[17.6px] mr-[16.79px] rounded-[16px]">
                    <div className="bg-[url('./assets/images/png/SliderAlien1.png')] Img_shadow rounded-[16px] lg:bg-BgSize bg-center bg-cover bg-no-repeat h-[340px] w-full max-w-[330px] flex items-end">
                      <div className="pl-[20px] pb-[20px] flex flex-col content_opacity">
                        <p className="ff_archivo text-[24px] font-normal text-white leading-[121%] mb-[6px]">
                          Evol Benji
                        </p>
